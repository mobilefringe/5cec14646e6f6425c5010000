<template>
    <div class="inside_header_background" v-if="pageBanner" :style="{ background: 'linear-gradient(0deg, rgba(219,108,34, 0.8), rgba(244,157,102, 0.8)), url(' + pageBanner.image_url + ') center center no-repeat rgba(219,108,34)' }">
