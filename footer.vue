        ...
        <section class="footer_menu main_container">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-4">
                    ...
                    <iframe aria-hidden="true" :title="'Google Map for ' + property.name" :src="siteInfo.googleMapURL" width="100%" height="130" frameborder="0" style="border:0" allowfullscreen></iframe>
                </div>
