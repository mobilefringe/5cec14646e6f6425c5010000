            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 footer_newsletter">
                    ...
                    <form id="subForm" class="js-cm-form" action="https://www.createsend.com/t/subscribeerror?description=" method="post" data-id="92D4C54F0FEC16E5ADC2B1904DE9ED1AD66DEBC54916A7BE63E2E4C35360483AB0DB2DA48965E79CC4D18E9C811C4F8D4892CB8814A6B6CE75EC2BAFDED9B38A">	
                        ...
                        <input autocomplete="Email" aria-label="Email" class="js-cm-email-input qa-input-email" placeholder="Your Email" id="fieldEmail" maxlength="200" name="cm-ydiuhrl-ydiuhrl" required="" type="email">
                ...
                <div>
                    <p class="footer_text">
                        <a :href="siteInfo.leasing" target="_blank">Leasing</a> |
                         <router-link to="/pages/norcovillage-retailer-hub" exact>Retailer Hub</router-link> |
