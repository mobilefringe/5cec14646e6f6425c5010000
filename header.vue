                    ...
                    <div class="header_social_container hidden-sm hidden-xs">
                        <div class="search_component_wrapper hidden_phone">
                            <div class="search_component_container">
                                <search-component v-if="headerReady" inputID="siteSearchDesktop" :list="searchList" placeholder="Search" :suggestion-attribute="suggestionAttribute" :keys="keys" v-model="search_result" @select="onOptionSelect" :autocomplete="false" :minMatchCharLength="3" :tokenize="true" class="text-left">
    					    ...
    					    <nav id="mobile_nav" v-show="showMenu" class="" role="navigation" aria-label="Mobile">
    					            ...
    					            <li v-for="(item,key) in menu_items" class="menu_item">
    							        ...
    							        <div v-else>
    							            <b-card no-body class="mb-1">
                                                ...
                                                <b-collapse v-model="item.show_sub_menu" :id="$t(item.name)" :visible="item.show_sub_menu" :accordion="$t(item.name)" class="accordion_body">
    						    ...
    						    <div class="mobile_nav_content">
                                    ...
                                    <div class="search_component_wrapper">
                                        <div class="search_component_container">
                                            <search-component v-if="headerReady" inputID="siteSearchMobile" :list="searchList" placeholder="Search" :suggestion-attribute="suggestionAttribute" :keys="keys" v-model="search_result" @select="onOptionSelect" :autocomplete="false" :minMatchCharLength="3" :tokenize="true" class="text-left">
                                                <template slot="item" scope="option" class="manual">
                                                    <article class="media">
                                                        <p>{{ option.data.name }}</p>
                                                    </article>
